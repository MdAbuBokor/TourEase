...
import { signOutFailure, signOutStart, signOutSuccess } from '../redux/accommodation/accommodationSlice';
      ...
      <div className="dropdown dropdown-end">
        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
          <div className="w-10 rounded-full">
            <img alt="Profile photo" src={currentAccommodation?.avatar} />
          </div>
        </div>
        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 border-b border-green-500">
          <li className='border-b border-green-500'>
            <Link to='/accommodation/update'>Profile</Link>
          </li>
